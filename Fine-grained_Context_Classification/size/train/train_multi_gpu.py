...
# ============================================================================
def setup_logging(output_dir='./qwen25_finetuned_size_specialist_multi_gpu'):
    """
...
tar_files = sorted(glob.glob(os.path.join(config.SIZE_WEBDATASET_DIR, 'train-*.tar')))

# Initialize logging before we start
output_dir = './qwen25_finetuned_size_specialist_multi_gpu'
...
# ============================================================================
if is_main_process():
    logging.info("🚀 Initializing SFTTrainer for Size Specialist (Multi-GPU)...")
...
try:
    ...
    if is_main_process():
        ...
        logging.info(f"✅ Training completed! Size specialist model saved to {CONFIG['output_dir']}/final_model")
