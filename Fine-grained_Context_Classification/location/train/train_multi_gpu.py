...
# ============================================================================
def setup_logging(output_dir='./qwen25_finetuned_location_specialist_multi_gpu'):
    """
...
output_dir = './qwen25_finetuned_location_specialist_multi_gpu'
...
# ============================================================================
if is_main_process():
    logging.info("🚀 Initializing SFTTrainer for location Specialist (Multi-GPU)...")
...
try:
    ...
    if is_main_process():
        ...
        logging.info(f"✅ Training completed! Location specialist model saved to {CONFIG['output_dir']}/final_model")
